...
class Blockchain:
    ...
    @staticmethod
    def vaild_proof(transactions, last_hash, nonce, difficulty=MINING_DIFFICULTY):
    ...
    def proof_of_work(self):
        ...
        nonce = 0
        while self.vaild_proof(self.transactions, last_hash, nonce) is False:
            nonce += 1
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            if not self.vaild_proof(transactions, block['previous_hash'], block['nonce'], MINING_DIFFICULTY):
                return False
